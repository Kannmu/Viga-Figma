...
- [Tool Calling | ZenMux | Documentation](#tool-calling-zenmux-documentation)

---

# Tool Calling | ZenMux | Documentation

> Source: [https://zenmux.ai/docs/guide/advanced/tool-calls.html](https://zenmux.ai/docs/guide/advanced/tool-calls.html)
...
### Defining a function tool (`function`) [​](#defining-a-function-tool-function)
...
### Handling tool calls (Tool calling) [​](#handling-tool-calls-tool-calling)
...
#### Merging results into the final response [​](#merging-results-into-the-final-response)
...
#### Controlling tool calling behavior (`tool_choice`) [​](#controlling-tool-calling-behavior-tool-choice)
...
### `tool_choice` parameter [​](#tool-choice-parameter)
...
### `tool_choice` parameter [​](#tool-choice-parameter-1)
